...
class LineFollower(Node):
    def __init__(self):
        ...
        # Variables dynamiques (initialisees avec des valeurs de repli sures)
        self.image_width = 640.0
        self.offset_near = 75.0  # Sera ecrase par l'auto-calibration
        ...
        # NOUVEAU : Abonnements à la configuration dynamique
        ...
        self.get_logger().info("LineFollower démarré — Prêt à recevoir la configuration dynamique")
    ...
    def compute_and_publish(self):
        ...
        # Si on n'a pas encore recu la taille de la camera, on ne fait rien !
        if self.image_width == 0.0:
            return

        twist = Twist()

        # On calcule les marges de sécurité dynamiquement à chaque boucle en fonction de l'image actuelle
